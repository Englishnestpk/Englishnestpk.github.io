...
function openPopup() {
    // Display the div with class "mpopupfive"
    document.querySelector('.mpopupfive').style.display = 'block';
...
function closePopup() {
    // Hide the div with class "mpopupfive"
    document.querySelector('.mpopupfive').style.display = 'none';
...
document.querySelector('.mpopfive').onclick = openPopup;
document.querySelector('#popupfive-mobile').onclick = closePopup;
