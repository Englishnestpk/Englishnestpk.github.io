...
function openPopup() {
    // Display the div with class "mpopuptwo"
    document.querySelector('.mpopuptwo').style.display = 'block';
...
function closePopup() {
    // Hide the div with class "mpopuptwo"
    document.querySelector('.mpopuptwo').style.display = 'none';
...
document.querySelector('.mpoptwo').onclick = openPopup;
document.querySelector('#popuptwo-mobile').onclick = closePopup;
