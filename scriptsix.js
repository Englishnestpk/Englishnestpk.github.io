...
function openPopup() {
    // Display the div with class "mpopupsix"
    document.querySelector('.mpopupsix').style.display = 'block';
...
function closePopup() {
    // Hide the div with class "mpopupsix"
    document.querySelector('.mpopupsix').style.display = 'none';
...
document.querySelector('.mpopsix').onclick = openPopup;
document.querySelector('#popupsix-mobile').onclick = closePopup;
