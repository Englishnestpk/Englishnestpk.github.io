...
function openPopup() {
    // Display the div with class "mpopupseven"
    document.querySelector('.mpopupseven').style.display = 'block';
...
function closePopup() {
    // Hide the div with class "mpopupseven"
    document.querySelector('.mpopupseven').style.display = 'none';
...
document.querySelector('.mpopseven').onclick = openPopup;
document.querySelector('#popupseven-mobile').onclick = closePopup;
